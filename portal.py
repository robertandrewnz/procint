...
def terrain_sample():
    body = (
        ...
        f'<div style="font-size:.65rem;font-weight:800;letter-spacing:.15em;text-transform:uppercase;margin-bottom:.3rem;">SAMPLE OUTPUT</div>'
        f'<div style="font-size:1.1rem;font-weight:700;">Terrain by BidEdge — Market Opportunity Scan</div>'
        f'<div style="font-size:.82rem;opacity:.85;margin-top:.25rem;">This is an example of a completed Terrain engagement. Client details are fictional.</div>'
        f'</div>'
        ...
        f'<h1 style="font-size:1.75rem;font-weight:900;color:#1E2D40;letter-spacing:-.02em;margin-bottom:.4rem;">Client A — Government ICT Services</h1>'
        f'<p style="font-size:.9rem;color:#666;margin-bottom:1.5rem;">Market Opportunity Scan · Central Government &amp; Education Sectors</p>'
        ...
        f'<div style="font-size:1rem;font-weight:700;">Market Sizing</div>'
        f'</div>'
        ...
        f'<div style="font-size:.78rem;color:#555;margin-top:.25rem;">Total NZ central government ICT services spend (MBIE procurement data, scaled from published agency budgets)</div>'
        f'</div>'
        ...
        f'<div style="font-size:.78rem;color:#555;margin-top:.25rem;">Agencies where Client A has capability fit and panel access or eligibility (~40% of TAM)</div>'
        f'</div>'
        f'<div style="background:#1E2D4008;border-left:4px solid #666;padding:.75rem 1rem;border-radius:4px;margin-left:3rem;">'
        f'<div style="font-size:.62rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#666;margin-bottom:.2rem;">SOM</div>'
        f'<div style="font-size:1.4rem;font-weight:800;color:#1E2D40;">$33M</div>'
        f'<div style="font-size:.78rem;color:#555;margin-top:.25rem;">Realistically contestable share based on firm size, existing relationships, and panel presence (~10% of SAM)</div>'
        f'</div>'
        f'<p style="font-size:.78rem;color:#666;font-style:italic;margin-top:1rem;border-top:1px solid #dde2e8;padding-top:.75rem;">Evidence-informed — based on MBIE procurement data, published agency ICT budgets, and AoG panel spend reporting. SOM assumes 3-4% market share achievable within 18 months given current pipeline.</p>'
        f'</div>'
        f'<div style="flex:1;min-width:280px;">'
        ...
        f'<div style="font-size:.78rem;color:#555;margin-top:.25rem;">Total tertiary and secondary sector ICT services spend</div>'
        f'</div>'
        f'<div style="background:#1E2D4012;border-left:4px solid #1E2D40;padding:.75rem 1rem;border-radius:4px;margin-bottom:.5rem;margin-left:1.5rem;">'
        f'<div style="font-size:.62rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#1E2D40;margin-bottom:.2rem;">SAM</div>'
        f'<div style="font-size:1.4rem;font-weight:800;color:#1E2D40;">$105M</div>'
        f'<div style="font-size:.78rem;color:#555;margin-top:.25rem;">Institutions above $5M ICT budget with outsourced delivery models</div>'
        f'</div>'
        f'<div style="background:#1E2D4008;border-left:4px solid #666;padding:.75rem 1rem;border-radius:4px;margin-left:3rem;">'
        f'<div style="font-size:.62rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#666;margin-bottom:.2rem;">SOM</div>'
        f'<div style="font-size:1.4rem;font-weight:800;color:#1E2D40;">$16M</div>'
        f'<div style="font-size:.78rem;color:#555;margin-top:.25rem;">Client A obtainable share based on current education sector presence</div>'
        f'</div>'
        f'<p style="font-size:.78rem;color:#666;font-style:italic;margin-top:1rem;border-top:1px solid #dde2e8;padding-top:.75rem;">Partially evidenced — TAM derived from TEC funding data and institutional ICT cost benchmarks. SOM assumes selective targeting of universities and large polytechnics only.</p>'
        f'</div>'
        f'</div>'
        f'</div>'
        ...
        f'<div style="font-size:1rem;font-weight:700;">Friction / Value Analysis</div>'
        f'</div>'
        f'<div style="background:#fff;border:1px solid #dde2e8;border-top:none;border-radius:0 0 8px 8px;padding:1.5rem;margin-bottom:2rem;">'
        f'<div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">'
        f'<thead><tr style="background:#1E2D40;">'
        f'<th style="padding:.7rem .9rem;text-align:left;font-size:.82rem;font-weight:700;color:#fff;border-right:1px solid #2a9d8f40;">Quadrant</th>'
        ...
        f'<th style="padding:.7rem .9rem;text-align:left;font-size:.82rem;font-weight:700;color:#fff;border-right:1px solid #2a9d8f40;">Example Clients</th>'
        f'<th style="padding:.7rem .9rem;text-align:left;font-size:.82rem;font-weight:700;color:#fff;">Action</th>'
        f'</tr></thead>'
        f'<tbody>'
        f'<tr style="background:#f8f9fa;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;white-space:nowrap;"><span style="color:#2a9d8f;font-weight:700;">&#9679;</span> <strong>High Value / Low Friction</strong></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">AoG panel-eligible agencies with open procurement cycles. Moderate RFP complexity, established evaluation criteria.</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Ministry of Social Development, Accident Compensation Corporation, Waka Kotahi</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;"><strong>Prioritise</strong> — resource BD here</td>'
        f'</tr>'
        f'<tr style="background:#fff;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;white-space:nowrap;"><span style="color:#2a9d8f;font-weight:700;">&#9679;</span> <strong>High Value / High Friction</strong></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Core government ICT programmes with heavy security requirements, incumbent lock-in, or lengthy prequal processes.</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">NZ Police, MBIE enterprise systems, Inland Revenue</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;"><strong>Engage strategically</strong> — relationships and panel presence required</td>'
        f'</tr>'
        f'<tr style="background:#f8f9fa;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;white-space:nowrap;"><span style="color:#666;font-weight:700;">&#9679;</span> <strong>Low Value / Low Friction</strong></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Smaller agencies and polytechnics with limited ICT budgets but accessible procurement.</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Tertiary Education Commission, small Crown entities, regional polytechnics</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;"><strong>Exploit if capacity available</strong> — do not overinvest</td>'
        f'</tr>'
        f'<tr style="background:#fff;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;white-space:nowrap;"><span style="color:#666;font-weight:700;">&#9679;</span> <strong>Low Value / High Friction</strong></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Remote or specialist agencies with high compliance burden relative to contract value.</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Defence-adjacent agencies, specialist regulators</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;"><strong>Avoid</strong> unless strategic access logic applies</td>'
        f'</tr>'
        f'</tbody></table></div>'
        f'</div>'
        ...
        f'<div style="font-size:1rem;font-weight:700;">Growth Signals</div>'
        f'</div>'
        f'<div style="background:#fff;border:1px solid #dde2e8;border-top:none;border-radius:0 0 8px 8px;padding:1.5rem;margin-bottom:2rem;">'
        f'<div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">'
        f'<thead><tr style="background:#1E2D40;">'
        ...
        f'<div style="font-size:1rem;font-weight:700;">High-Fit BD Targets</div>'
        f'</div>'
        f'<div style="background:#fff;border:1px solid #dde2e8;border-top:none;border-radius:0 0 8px 8px;padding:1.5rem;margin-bottom:2rem;">'
        f'<div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">'
        f'<thead><tr style="background:#1E2D40;">'
        ...
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Education</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;"><span style="color:#666;font-weight:600;">MEDIUM</span></td>'
        ...
        f'<div style="font-size:1rem;font-weight:700;">Competitiveness Summary</div>'
        f'</div>'
        f'<div style="background:#fff;border:1px solid #dde2e8;border-top:none;border-radius:0 0 8px 8px;padding:1.5rem;margin-bottom:2rem;">'
        f'<div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;">'
        f'<thead><tr style="background:#1E2D40;">'
        ...
        f'<p style="color:rgba(255,255,255,.8);font-size:.87rem;margin-bottom:1rem;">Ready to see what Terrain can do for your organisation?</p>'
...
def keystone_sample():
    body = (
        ...
        f'<div style="background:#2a9d8f;color:#fff;text-align:center;padding:1rem 1.5rem;margin-bottom:0;">'
        f'<div style="font-size:.65rem;font-weight:800;letter-spacing:.15em;text-transform:uppercase;margin-bottom:.3rem;">SAMPLE OUTPUT</div>'
        f'<div style="font-size:1.1rem;font-weight:700;">Keystone by BidEdge — Executive Decision Pack</div>'
        f'<div style="font-size:.82rem;opacity:.85;margin-top:.25rem;">This is an example of a completed Keystone engagement. Client details are fictional.</div>'
        f'</div>'
        f'<div style="max-width:960px;margin:0 auto;padding:2.5rem 1.5rem 5rem;">'
        f'<div style="margin-bottom:2.5rem;padding-top:.5rem;">'
        ...
        f'<h1 style="font-size:1.75rem;font-weight:900;color:#1E2D40;letter-spacing:-.02em;margin-bottom:.4rem;">Client B — Pacific Ports Authority</h1>'
        f'<p style="font-size:.9rem;color:#666;margin-bottom:1.5rem;">Executive Decision Pack &middot; Integrated Intelligence Synthesis</p>'
        ...
        f'<td style="padding:.7rem .9rem;font-size:.84rem;">Commerce Commission investigation into port sector pricing practices is active. Two related Port Authority cases have set precedent for pricing transparency obligations. Regulatory exposure elevated; legal cost risk is material over 18-month horizon.</td>'
        f'</tr>'
        f'<tr style="background:#fff;">'
        ...
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;"><span style="background:#E67E22;color:#fff;font-size:.7rem;font-weight:700;padding:.2rem .55rem;border-radius:4px;letter-spacing:.04em;">AMBER ↗</span></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;">Pacific Ports Authority holds a natural geographic monopoly for container throughput in its catchment. No near-term competitive threat from alternative port infrastructure. Landside logistics competitors (road, rail) are gaining share on high-value cargo segments; monitoring required but not a strategic threat within 3 years.</td>'
        f'</tr>'
        f'<tr style="background:#f8f9fa;">'
        ...
        f'</div>'
        f'<div style="background:#fff;border:1px solid #dde2e8;border-top:none;border-radius:0 0 8px 8px;padding:1.5rem;margin-bottom:2rem;">'
        f'<p style="font-size:.85rem;color:#666;margin-bottom:1.25rem;">Where two or more streams point to the same underlying issue. These are the highest priority items.</p>'
        ...
        f'</div>'
        f'<div style="background:#fff;border:1px solid #dde2e8;border-top:none;border-radius:0 0 8px 8px;padding:1.5rem;margin-bottom:2rem;">'
        f'<p style="font-size:.85rem;color:#666;margin-bottom:1.25rem;">These items reflect convergence across all four input streams. For each item select Act, Watch, or Defer. Record decision and owner in Section 04. Decisions can be made in the context of current capex constraints and contractor market conditions.</p>'
        f'<div style="overflow-x:auto;"><table style="width:100%;border-collapse:collapse;border:1px solid #dde2e8;">'
        ...
        f'<tbody>'
        f'<tr style="background:#f8f9fa;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;"><strong>ComCom investigation scope and likely timeline</strong></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;">Determines whether regulatory cost risk is $200K or $2M; changes the materiality weighting of all capex decisions</td>'
        f'</tr>'
        f'<tr style="background:#fff;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;"><strong>Revenue forecast confidence interval under base and downside scenarios</strong></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;">Covenant breach risk is highly sensitive to revenue assumptions; a 5% revenue downside moves D/E to 2.05x — above the breach threshold</td>'
        f'</tr>'
        f'<tr style="background:#f8f9fa;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;"><strong>Crane manufacturer lead time and pricing validity window</strong></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;">If lead times have extended since the original quote, the Q2 procurement window may not yield the expected delivery timeline; changes the deferral calculus</td>'
        f'</tr>'
        f'<tr style="background:#fff;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;"><strong>Lender covenant waiver appetite</strong></td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;">If lenders would grant a temporary covenant waiver for a strategic capex programme, the balance sheet constraint is less binding than the current analysis suggests</td>'
        f'</tr>'
        f'</tbody></table></div>'
        ...
        f'<tbody>'
        f'<tr style="background:#f8f9fa;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Crane acquisition programme</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'</tr>'
        f'<tr style="background:#fff;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Regulatory counsel engagement</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'</tr>'
        f'<tr style="background:#f8f9fa;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Q2 crane programme decision gate</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'</tr>'
        f'<tr style="background:#fff;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;">Landside cargo segment analysis</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;color:#aaa;font-style:italic;text-align:center;">&mdash;</td>'
        f'</tr>'
        ...
        f'</div>'
        f'<div style="text-align:center;padding:2rem;background:#1E2D40;border-radius:8px;margin-top:1rem;">'
        f'<p style="color:rgba(255,255,255,.8);font-size:.87rem;margin-bottom:1rem;">See how Keystone can integrate your intelligence streams into a clear decision agenda.</p>'
