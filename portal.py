...
def terrain_sample():
    body = (
        ...
        f'</tr>'
        f'<tr style="background:#f8f9fa;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;white-space:nowrap;"><span style="color:#1E2D40;font-weight:700;">&#9679;</span> <strong>Low Value / Low Friction</strong></td>'
        ...
        f'</tr>'
        f'<tr style="background:#fff;">'
        f'<td style="padding:.7rem .9rem;font-size:.84rem;border-right:1px solid #dde2e8;white-space:nowrap;"><span style="color:#1E2D40;font-weight:700;">&#9679;</span> <strong>Low Value / High Friction</strong></td>'
