...
def terrain_sample():
    body = (
        ...
        f'<div style="font-size:12px;opacity:.8;margin-top:6px;">e.g. MSD, ACC, Waka Kotahi</div>'
        f'</div>'
        ...
        f'<div style="font-size:12px;opacity:.8;margin-top:6px;">e.g. NZ Police, MBIE enterprise, IRD</div>'
        f'</div>'
        ...
        f'<div style="font-size:12px;opacity:.8;margin-top:6px;">e.g. TEC, small Crown entities, polytechnics</div>'
        f'</div>'
        f'<div style="background:#2C2C2C;padding:1.5rem;color:rgba(255,255,255,.85);">'
        ...
        f'<div style="font-size:12px;opacity:.8;margin-top:6px;">e.g. Defence-adjacent, specialist regulators</div>'
        f'</div>'
        f'</div>'
...
def keystone_sample():
    body = (
        ...
        f'<p style="font-size:.9rem;color:#1E2D40;margin-bottom:1.5rem;">Executive Decision Pack &middot; Integrated Intelligence Synthesis</p>'
