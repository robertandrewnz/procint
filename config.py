...
SECTOR_KEYWORDS: dict[str, list[str]] = {
    ...
    "ICT": [
        ...
        "cloud services", "cloud migration", "SaaS", "cloud solution",
        "database", "data platform", "data warehouse", "data solution",
        "analytics platform", "business intelligence",
        "technology services", "digital services", "software solution",
        "all-of-government", "AoG ICT",
        "contact centre", "contact center",
        "digital platform", "technology solution", "ICT solution",
        "CRM", "API integration", "API platform",
